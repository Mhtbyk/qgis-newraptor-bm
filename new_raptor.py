...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2023-01-03
        git sha              : $Format:%H$
        copyright            : (C) 2023 by Mahmut Bülbül
        email                : bulbulmahmut@yahoo.com
 ***************************************************************************/
...
class NewRaptor:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.cmbSpecies.currentTextChanged.connect(self.evt_cmbSpeices_changed)
    ...
    def evt_cmbSpeices_changed(self,speices):
        if speices=="Swainsons Hawk":
